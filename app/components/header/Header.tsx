  ...
  return (
    <header className="bg-[#d2d2d2a5] backdrop-blur-[5px] shadow-[0_0_5px_0_rgba(0,0,0,0.1)] fixed top-5 left-0 right-0 z-50 mx-2 lg:mx-24 rounded-full">
                  ...
                  {/* <div className="grid grid-cols-2 divide-x divide-gray-200 bg-gray-200">
                    {callsToAction.map((item) => (
                      <Link
                        key={item.name}
                        href={item.href}
                        className="flex items-center justify-center gap-x-2.5 p-3 text-sm/6 font-semibold text-gray-900 hover:bg-gray-300"
                      >
      ...
      <Dialog open={mobileMenuOpen} onClose={setMobileMenuOpen} className="lg:hidden">
        ...
        <DialogPanel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white p-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10 rounded-2xl">
